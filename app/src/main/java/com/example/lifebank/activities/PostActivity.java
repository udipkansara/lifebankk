...
public class PostActivity extends AppCompatActivity {
    ...
    Button btnpost;
    //CheckBox checkBoxa1,checkBoxa2,checkBoxb1,checkBoxb2,checkBoxab1,checkBoxab2,checkBoxo1,checkBoxo2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       /* checkBoxa1=findViewById(R.id.a1);
        checkBoxa2=findViewById(R.id.a2);
        checkBoxb1=findViewById(R.id.b1);
        checkBoxb2=findViewById(R.id.b2);
        checkBoxab1=findViewById(R.id.ab1);
        checkBoxab2=findViewById(R.id.ab2);
        checkBoxo1=findViewById(R.id.o1);
        checkBoxo2=findViewById(R.id.o2);*/
